...
try {
    ...
    $db_user = $online==TRUE? "":'root';
    $db_pass = $online==TRUE? "admin@2018":'root';
    $db_name = $online==TRUE? 'polar_db':'polar_db';
    $connection_string = "mysql:host=157.230.229.119;dbname=polarman_ats;port=10330"; 
    $conn = new PDO($connection_string, "root","VF3ax6geGdfg32dufgf8", 
