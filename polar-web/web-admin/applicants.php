                  ...
                  <div class="card-body">
                      <div class="table-responsive">
                          ...
                          <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                              ...
                              <tbody>
                                  <?php
                                      if($applicants = db_get_all("SELECT * FROM applicant_info ORDER BY first_name ASC ")){
                                      //var_dump($users);
                                          $count = 0;
                                          foreach($applicants AS $row){
                                              ...
                                              $btn_del = '<button class="btn btn-sm btn-danger" data-id="'.$row->id.'"  data-tbl="applicant_info" data-msg="'.$del_msg.'"  data-toggle="modal" data-target="#deleteModal" ><i class="fa fa-trash"></i></button>';
